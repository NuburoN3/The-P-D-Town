  ...
  function render() {
    ...
    renderGameFrame({
      ...
      state: {
        ...
        brogDeathBursts: Array.isArray(brogDeathBursts) ? brogDeathBursts : [],
        ...
        combatRewardPanel,
        playerStatusEffects: {
          poisonedUntil: Number.isFinite(combatStatusState?.poisonedUntil) ? combatStatusState.poisonedUntil : 0,
          poisonDurationMs: Number.isFinite(combatStatusState?.poisonDurationMs) ? combatStatusState.poisonDurationMs : 0
        },
        minimap,
        doorHintText,
        pauseMenuState,
